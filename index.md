...
hero:
  ...
  text: "Algorithmie pragmatique pour développeurs JavaScript"
  tagline: "Complexité, structures de données, graphes, DP et patterns terrain"
  actions:
    - theme: brand
...
features:
  - title: 13 Modules progressifs
    details: Des fondations Big-O jusqu'aux patterns d'ingénierie rencontrés en frontend et backend.
  - title: 12 Labs pratiques
    details: Exercices TypeScript courts et ciblés pour ancrer chaque structure ou raisonnement.
  - title: Quizzes & visualisations
    details: Validation rapide des notions et support visuel pour les structures plus abstraites.
---
